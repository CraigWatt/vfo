# Craigstreamy HEVC Smart English Subtitle Convert Audio Conform Legacy Sub-HD Profile
...
| Scenario | Command |
| --- | --- |
| `RES_JUST_RIGHT` | `transcode_hevc_legacy_smart_eng_sub_subtitle_convert_audio_conform_profile.sh` |
