# Craigstreamy HEVC Smart English Subtitle Convert Audio Conform 1080p Profile
...
| Scenario | Command |
| --- | --- |
| `RES_JUST_RIGHT COLOR_SPACE_JUST_RIGHT` | `transcode_hevc_1080_smart_eng_sub_subtitle_convert_audio_conform_profile.sh` |
