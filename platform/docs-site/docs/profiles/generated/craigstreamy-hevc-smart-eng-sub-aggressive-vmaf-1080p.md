# Craigstreamy HEVC Smart English Subtitle Aggressive VMAF 1080p Profile
...
| Scenario | Command |
| --- | --- |
| `RES_JUST_RIGHT COLOR_SPACE_JUST_RIGHT` | `transcode_hevc_1080_smart_eng_sub_aggressive_vmaf_profile.sh` |
