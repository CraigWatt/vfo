# Craigstreamy HEVC Smart English Subtitle Audio Conform Legacy Sub-HD Profile
...
| Scenario | Command |
| --- | --- |
| `RES_JUST_RIGHT` | `transcode_hevc_legacy_smart_eng_sub_audio_conform_profile.sh` |
