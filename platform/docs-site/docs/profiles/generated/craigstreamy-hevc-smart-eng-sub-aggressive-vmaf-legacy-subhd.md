# Craigstreamy HEVC Smart English Subtitle Aggressive VMAF Legacy Sub-HD Profile
...
| Scenario | Command |
| --- | --- |
| `RES_JUST_RIGHT` | `transcode_hevc_legacy_smart_eng_sub_aggressive_vmaf_profile.sh` |
