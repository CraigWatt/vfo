...
### 1) Policy filename mismatch

- Current repo had `AGENTS.md` (plural) but no `AGENT.md`.
- This creates ambiguity for humans and tools when referencing policy docs.
...
2. Keep `AGENTS.md` as compatibility alias that points to `AGENT.md` (done).
